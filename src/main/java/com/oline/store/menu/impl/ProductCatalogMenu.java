...
import com.oline.store.services.ProductManagementService;
import com.oline.store.services.impl.DefaultProductManagementService;
...
public class ProductCatalogMenu implements Menu {
	...
	private Product fetchProduct(String userInput){
		int productIdAddToCart = Integer.parseInt(userInput);
		Product productToAddToCart = productManagementService.getProductById(productIdAddToCart);
